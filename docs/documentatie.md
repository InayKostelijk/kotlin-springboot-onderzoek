...
Je zou denken is er niet al een taal die hetzelfde doet namelijk Java. 


### Waarom bestaat kotlin?
De lead van JetBrains Dmitry Jemerov vond dat de meeste talen niet de features hadden waar Jetbrains voor zocht. Met uitzondering van Scala, alleen Scala had een langzame compiliatie tijd. 
...
#### Notities
Een van de eerste dingen die mij opviel was dat in java gebruik je private en dan de variable maar in kotlin is het anders.
Namelijk open en dan var variable. 

Ook het gebruik van var en val is anders dan in java.
